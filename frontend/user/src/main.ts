...
import './style.css'
import './templates/minimal/styles/minimal.css'
import './templates/market/styles/market.css'
import './templates/noir/styles/noir.css'
import './templates/atlas/styles/atlas.css'
